...
topic_info.to_csv(OUTPUT_DIR / "guardian_bertopic_topic_info.csv", index=False)
...
topic_words_df.to_csv(OUTPUT_DIR / "guardian_bertopic_topic_words.csv", index=False)

doc_topics = df[["title", "section", "date", "url"]].copy()
doc_topics["topic"] = topics
doc_topics.to_csv(OUTPUT_DIR / "guardian_bertopic_document_topics.csv", index=False)
